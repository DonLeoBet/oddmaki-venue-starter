  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 text-gray-200 font-sans leading-relaxed">
      ...
      <p className="text-lg mb-6">
        Look, we&apos;re football lads through and through. For years, we sat on
        the terraces, screaming our lungs out, and later trying to back our
        shouts on traditional betting exchanges. But let&apos;s be honest—those
        corporate bookies always miss the proper bets. The liquidity is dead,
        the odds are rigged in their favor, and the markets we actually wanted
        to trade just didn&apos;t exist.
      </p>
      ...
      <div className="border-l-4 border-cyan-500 bg-gray-900 p-4 rounded mt-8">
        <p className="italic text-sm text-gray-400">
          &quot;Back your knowledge. Trade the match. Own the terraces.&quot; —
          The Poly.Football Crew
        </p>
      </div>
    </div>
  );
