    ...
    <div style={{ display: "grid", gap: 16 }}>
      ...
      <ReviewSection title="Trading & Oracle">
        <ReviewRow
          ...
          value={formData.liquidityMode === "pool" ? "Pool" : "Order Book"}
        />
        {formData.liquidityMode === "pool" ? (
          <>
            <ReviewRow
              label="Opens"
              value={
                formData.openMode === "scheduled" && formData.openDatetime
                  ? new Date(formData.openDatetime).toLocaleString()
                  : "Immediately"
              }
            />
            <ReviewRow
              ...
              value={
                formData.closeDatetime
                  ? new Date(formData.closeDatetime).toLocaleString()
                  : "(not set)"
              }
            />
          </>
